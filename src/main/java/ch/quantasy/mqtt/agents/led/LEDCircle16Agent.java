 ...
 * @author reto
 */
public class LEDCircle16Agent extends GenericTinkerforgeAgent {

    private final List<AnLEDAbility> abilities;
    private final int frameDurationInMillis;
    private final int amountOfLEDs;

    public LEDCircle16Agent(URI mqttURI) throws MqttException {
        ...
        subscribe(ledServiceContract1.EVENT_LAGING, (topic, payload) -> {
            ...
            Logger.getLogger(LEDCircle16Agent.class.getName()).log(Level.INFO, "Laging:", Arrays.toString(lag.toArray(new Object[0])));
        });
    ...
    public static void main(String[] args) throws Throwable {
        ...
        LEDCircle16Agent agent = new LEDCircle16Agent(mqttURI);
        System.in.read();
    }
}
