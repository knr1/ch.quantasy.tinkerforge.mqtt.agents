...
public class ImageToStripe extends AnLEDAbility {
    ...
    public ImageToStripe(GatewayClient gatewayClient, LEDStripServiceContract ledServiceContract, LEDStripDeviceConfig config) {
        ...
        try {
            ...
            while (true) {
                while (frames.size() < 150) {
                    ...
                    i+=1000;
                    newLEDs.setDurationInMillis((i%10000)+1);
