 ...
 * @author reto
 */
public class ConcurrentPoties extends GenericTinkerforgeAgent {

    private StackManagerServiceContract managerServiceContract;
    private Random random;

    public ConcurrentPoties(URI mqttURI) throws MqttException, InterruptedException {
        super(mqttURI, "30309hjph", new GenericTinkerforgeAgentContract("MotorizedLinearPoti", "concurrent"));
        random = new Random();
        connect();
        ...
        MotorizedLinearPotiIntent intent=new MotorizedLinearPotiIntent();
    ...
    public static void main(String... args) throws Throwable {
        ...
        ConcurrentPoties agent = new ConcurrentPoties(mqttURI);
        System.in.read();
        agent.finish();
    }
